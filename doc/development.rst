...
Since the tests should not rely on an external OAI server, static OAI responses stored in 
files are used instead. To this end, a mock version of the :meth:`sickle.app.Sickle.harvest`
